...
<div class="post border-div @php echo ($new==1)? 'new':'old' @endphp" data-count={{$count}}>
    ...
    <div class="actions" data-id={{$post->id}}>
        <div class="action-item like" onclick="action(0, event);">
...
<span class="like-count"> {{$likes}} </span>
        ...
        <div class="action-item dislike" onclick="action(1, event);">
 ...
 <span class="dislike-count"> {{$dislikes}} </span>
        ...
        <div class="action-item like"  onclick="comment(event);">
        ...
        <div class="action-item like" onclick="action(2, event);">
